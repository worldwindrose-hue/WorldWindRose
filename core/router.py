"""
ROSA OS — Router wrapper for the FastAPI layer.
Adapts the existing HybridRouter for use in async HTTP context.
"""
...
class RosaRouter:
    ...
    def __init__(self) -> None:
        ...
        # Inject settings as env vars so HybridRouter picks them up
